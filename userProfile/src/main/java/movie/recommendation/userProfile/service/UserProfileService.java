...
//	UserRepository userRepository;
	...
	public UserProfileDetails getUserProfileDetails(int id)
	{
		...
		MovieGenre[] response = restTemplate.getForObject("http://localhost:8009/user/"+String.valueOf(id), MovieGenre[].class);		
	...
	//id and value	//userProfileDetails.setMovieGenre(response);
